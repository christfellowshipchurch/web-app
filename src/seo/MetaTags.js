...
const metaTags = ({
  ...
  <MetaTags>
    ...
    {openGraphProtocols.map((n, i) => (
      <meta property={`og:${n.name}`} content={n.content} key={i} />
    ))}
    {twitterProtocols.map((n, i) => (
      <meta name={`twitter:${n.name}`} content={n.content} key={i} />
    ))}
  </MetaTags>
);
...
const defaultItems = {
  ...
  description:
    'At Christ Fellowship Church, our goal is to help you know God, grow in your relationships, and discover your purpose so that you can impact the world.',
