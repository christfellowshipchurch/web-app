              ...
              <div className={classnames('d-flex', 'flex-column', 'align-items-center')}>
                ...
                {!profileImage && (
                  <div className="rounded-circle bg-white">
                    <Icon name="user-circle" size={120} fill="#00aeef" />
                  </div>
                )}

                <h1 className={classnames('text-white', 'text-center', 'mt-3')}>
                  {/* Profile Name */}
                  {`${get(data, 'currentUser.profile.firstName')} ${get(
                    data,
...
ProfileBanner.defaultProps = {
  coverImage: '',
  profileImage:
    'https://i0.wp.com/acaweb.org/wp-content/uploads/2018/12/profile-placeholder.png?fit=300%2C300&ssl=1',
  name: 'Abiding Aaron',
