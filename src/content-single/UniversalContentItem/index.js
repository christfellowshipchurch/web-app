...
import { Media, ErrorBlock, Share } from '../../ui';
...
const UniversalContentItem = ({ itemId, loading, error, content }) => {
  ...
  return (
    <>
      <div className="pt-6 bg-white px-3">
        <div className="container">
          <div className="row">
            <div className="col">
              {get(content, 'title', '') !== '' && (
                <h1 className="mb-2 text-dark">{content.title}</h1>
              )}
              ...
              >
                ...
                <Share title={content.title} variant={'outline-dark'} />
              </div>
      ...
      {/* Temporarily Commenting out Realated Articles */}
