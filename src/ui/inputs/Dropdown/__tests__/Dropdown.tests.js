...
describe('Dropdown', () => {
  it('renders a Dropdown without crashing', () => {
    const tree = renderer.create(<Dropdown label="Label" description="Description" />);
  ...
  it('renders a Dropdown with a placeholder', () => {
    const tree = renderer.create(
      <Dropdown label="Label" description="Description" placeholder="Placeholder" />
    );
  ...
  it('renders a Dropdown with an error', () => {
    const tree = renderer.create(
      <Dropdown label="Label" description="Description" error="Here's an error" />
    );
  ...
  it('renders a Dropdown with using success', () => {
    const tree = renderer.create(
      <Dropdown label="Label" description="Description" withSuccess />
    );
  ...
  it('renders a disabled Dropdown', () => {
    const tree = renderer.create(
      <Dropdown label="Label" description="Description" disabled />
    );
  ...
  it('simulates the click of a Dropdown', () => {
    const wrapper = mount(<Dropdown label="Label" description="Description" />);
