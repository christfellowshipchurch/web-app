...
export const PreSearchFeed = ({ hide }) => (
  <div className={classnames('text-center', 'p-6', 'vh-100', { 'd-none': hide })}>
...
export const LoadingFeed = () => (
  <div className="row p-2">
    <div className="col-12 col-md-6">
      {blankCards.map((n, i) => (
        <ContentCardConnected key={i} isLoading card={TileRowCard} />
      ))}
    </div>
    <div className="col-12 col-md-6">
      {blankCards.map((n, i) => (
...
export const ErrorFeed = ({ searchText }) => (
  <div className={classnames('text-center', 'p-6', 'vh-100')}>
    <h3 className="text-secondary">Uh Oh!</h3>
    <p></p>
    <p>
      Looks like we couldn't find anything for "<b>{searchText}</b>." Try searching for
      something else!
    </p>
  </div>
);
