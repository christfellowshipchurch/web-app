...
const LoginCard = () => {
  ...
  const columnSizes = ['col-12', 'col-lg-8'];

  return (
    <FloatingCard onPressExit={() => hideLogIn()}>
      <h2 className={classnames('text-center', 'mt-2', 'mb-3')}>Login</h2>
      ...
      >
        ...
        <Carousel.Item>
          <h2 className="text-center text-success">You're now logged in!</h2>
        </Carousel.Item>
