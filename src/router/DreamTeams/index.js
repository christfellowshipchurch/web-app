...
import { DreamTeams, GroupContentItemConnected } from '../../groups';

import redirects from '../../redirects.json';

const DreamTeamSingle = ({
  ...
  if (!isLoggedIn || !contentId) return <Redirect to="/dream-team" />;
  ...
  if (includes(contentId, 'Volunteer')) {
    contentId = contentId.replace('Volunteer', '');
  }
...
const Router = () => (
  <Switch>
    <Route exact path="/dream-teams/:groupName" component={DreamTeamSingle} />

    <Route path="*" component={DreamTeams} />
  </Switch>
);
