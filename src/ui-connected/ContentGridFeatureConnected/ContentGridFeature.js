...
const ContentGridFeature = ({ blocks, PreviewComponent, FocusedComponent }) => {
  ...
  return (
    <div
      ...
      className={classnames('p-relative', 'container-fluid')}
    >
      <div
        style={{
      ...
      >
        {blocks.map((n, i) => (
          <div
            className={classnames('col-12', 'col-md-6', 'px-1', 'py-2')}
            key={`CardContainer:${i}`}
            size={{ xs: '6' }}
          >
      ...
      >
        {activeCard >= 0 &&
          React.createElement(FocusedComponent, {
            ...blocks[activeCard],
